...
const NAV = [
  { label: "Overview", href: "/", active: true, soon: false },
  { label: "Flows", href: "#", active: false, soon: true },
  { label: "Sessions", href: "#", active: false, soon: true },
  { label: "Webhooks", href: "#", active: false, soon: true },
